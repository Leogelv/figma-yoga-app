...
## Текущая задача: Реструктуризация компонентов и архитектуры приложения
...
## Следующие шаги
- 🔴 Перенос всех оставшихся компонентов из quiz-flow и practice-flow в новую структуру
- 🔴 Обновление всех import-ов в компонентах
- 🔴 Тестирование приложения после миграции
- 🔴 Удаление старых папок quiz-flow и practice-flow
...
- 🔴 Решить проблему с отсутствующими полями в components/ui/button/Button.tsx после реорганизации структуры
